class Persona {
    ...
    toString (){
        return "N° de persona: " + this._idPersona + ", " + this._apellido + " " + this._nombre + ", " + this._edad + " años"
    }
}
...
class Empleado extends Persona {
    ...
    toString (){
       ...
       return  super.toString() + ", n° de empleado: " + this._idEmpleado + ", sueldo: $" + this._sueldo ;
    }
}
...
class Cliente extends Persona {
    ...
    toString (){
        ...
        return super.toString() + ", n° de cliente: " + this._idCliente + ", Fecha de registro: " + this._fechaRegistro;
    }
}
